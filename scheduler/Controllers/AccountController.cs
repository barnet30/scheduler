...
namespace scheduler.Controllers
{
    public class AccountController : Controller
    {
        ...
        private async Task Authenticate(string userName)
        {
            ...
            ClaimsIdentity UserId = new ClaimsIdentity(claims, "ApplicationCookie", ClaimsIdentity.DefaultNameClaimType, ClaimsIdentity.DefaultRoleClaimType);
            // установка аутентификационных куки
            await HttpContext.SignInAsync(CookieAuthenticationDefaults.AuthenticationScheme, new ClaimsPrincipal(UserId));
        }
